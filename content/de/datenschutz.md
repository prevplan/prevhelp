...
* **umami.is:** Reichweitenmessung und Webanalytics; kein Einsatz von Cookies oder vergleichbaren persistenten Onlinekennzeichen; es werden keine personenbezogenen Daten gespeichert; die Verarbeitung erfolgt auf unserem Server, es werden keine Daten an Dritte weitergegeben; **Dienstanbieter:** Hosting auf unserem Server; **Website:** [https://umami.is/](https://umami.is/)
